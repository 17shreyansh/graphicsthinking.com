...
const ServiceCard = ({ service, index }) => {
  ...
  const colorConfig = {
    red: { icon: 'brand.red', price: 'brand.red', button: 'red' },
    blue: { icon: 'brand.blue', price: 'brand.blue', button: 'blue' },
    brown: { icon: 'brand.brown', price: 'brand.brown', button: 'orange' }
  }
  ...
  return (
    ...
    >
      ...
      <Heading size="md" mb={4} fontFamily="accent" color="gray.800">{service.name}</Heading>
      <Text color="gray.600" mb={6} lineHeight="1.6">{service.description}</Text>
      <Text fontSize="2xl" fontWeight="bold" color={colorConfig[colorScheme].price} mb={4}>
